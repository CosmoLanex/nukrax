  ...
  container.innerHTML = posts.map(post => {
    ...
    return `
      <article class="cm-post" data-post-id="${post.id}" data-author-id="${post.user_id}">
        <div class="cm-post-avatar">${avatarUrl ? `<img src="${escapeHtml(avatarUrl)}" alt="">` : initial}</div>
        <div class="cm-post-body">
          <div class="cm-post-head">
            <span class="cm-post-name">${escapeHtml(authorName)}</span>
            <span class="cm-post-handle">${escapeHtml(authorHandle)}</span>
