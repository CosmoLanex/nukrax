  ...
  if (view === 'login' || view === 'signup') {
    ...
    modal.querySelector('#nkx-form').addEventListener('submit', async (e) => {
      ...
      if (view === 'signup') {
        ...
        setMsg('Check your email and click the confirmation link to finish signing up.', false);
        return;
      }
      ...
      setMsg('Check your email and click the link to finish logging in.', false);
    });
    return;
  }
